...
func renderHelpText(width int) string {
	...
	for i, spec := range commandSpecs() {
		...
		b.WriteString("\n")
		b.WriteString(usageStyle.Render("Sử dụng: " + spec.Usage))
		b.WriteString("\n")
	...
	for _, line := range []string{
		...
		"↑↓ Chọn lệnh trong danh sách",
		"Tab/Enter Chấp nhận hoàn thành",
		"Esc Đóng bảng lệnh hiện tại",
		"Ctrl+R Chuyển chế độ sao chép (tắt báo cáo chuột để kéo chọn, nhấn lại để khôi phục)",
	} {
